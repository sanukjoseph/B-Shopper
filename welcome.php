...
?>
<!--========================================Welcome page with signout and forget password===================================-->
 ...
 <body>
   ...
   <section id="nav-bar">
    <nav class="navbar navbar-expand-lg navbar-light" style="height: 10%;">
      <a class="navbar-brand" href="#"><img src="./Images/logo.png" height="100px" width="auto"></a>
   ...
   <section id="slider">
    <div id="headerSlider" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-caption"><h5 style=" font-size: 40px; font-family: 'Audiowide', cursive;" >B-SHOPPER</h5>
        <h6>Welcome back to B-Shopper <?php echo htmlspecialchars($_SESSION["username"]); ?> </h6>
        ...
        </div></div><input type="text" placeholder="Search for an item"></div>
      </div>
        ...
        <div class="carousel-item"><img src="./Images/book.jpg" class="d-block img-fluid" style="height:60%; width: 100%;">
          ...
          <h5 style=" font-size: 40px; font-family: 'Audiowide', cursive;" >B-SHOPPER</h5>
          <h6>Welcome back to B-Shopper <?php echo htmlspecialchars($_SESSION["username"]); ?> </h6>
          <div class="dropdown">
          <button class="dropbtn" style="font-size: 13px;">Location 
          <i class="fa fa-angle-down" style="font-size:16px "></i></button>
   ...
   <section id="contact">
    <div class="container">
      <h1 style="text-align: center; font-size: 30px;">Contact</h1>
     <div class="row">
       <div class="col-md-6">
